...
public class StudentDAO extends DataBaseDAO implements Login_RegisterInterface, CourseSourcesInterface, CheckInInterface, HomeworkInterface, QuestionReplyInterface,GradeInterface {
